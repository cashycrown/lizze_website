...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     'django.contrib.sites',  # REMOVE to avoid duplicate 'sites' error
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'Lashify_Artistry' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DEFAULT_FROM_EMAIL = "olamideadedokun36@gmail.com"   # Or your business email
